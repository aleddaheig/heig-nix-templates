        ...
        { pkgs }:
        {
          default = pkgs.mkShell.override { } {
            ...
            shellHook = ''
              ...
              export QT_PLUGIN_PATH="${pkgs.qt6.full}/lib/qt-6/plugins:${pkgs.qt6.qtbase}/lib/qt-6/plugins:$QT_PLUGIN_PATH"
              export NIXPKGS_QT6_QML_IMPORT_PATH="${pkgs.qt6.full}/lib/qt-6/qml:$NIXPKGS_QT6_QML_IMPORT_PATH" 
